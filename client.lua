...
function AddMenuStation(menu)
    ...
    menu.OnItemSelect = function(sender, item, index)
        AllowMenu = false
        Index = index
        TriggerServerEvent("qb-metro:server:TravelRequest", index)
...
RegisterNetEvent("qb-metro:client:TimeLeft", function(minsleft)
...
RegisterNetEvent("qb-metro:client:TrainArrival", function()
...
RegisterNetEvent("qb-metro:client:StayInZone", function()
